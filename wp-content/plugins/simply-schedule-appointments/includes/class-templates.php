...
class SSA_Templates {
	...
	public function add_appointment_template_vars( $vars, $template ) {
		...
		$vars['Appointment']['customer_start_date'] = ssa_datetime( $vars['Appointment']['start_date'] )->setTimezone( new DateTimeZone( $vars['Appointment']['customer_timezone'] ) )->format( $format );
