<?php $translations = array (
  ...
  array (
    ...
    'businessText' => __( 'Did you know we’re constantly working on new, powerful features for business customers? Sign up for our Business Edition today and receive our latest features as they’re released:', 'simply-schedule-appointments' ),
    'businessTextBullets' => 
    array (
      'team' => __( 'Team and Employee Scheduling', 'simply-schedule-appointments' ),
      'resources' => __( 'Manage Resources and Equipment', 'simply-schedule-appointments' ),
    ...
    'plusText' => __( 'Interested in getting even more out of SSA? Consider upgrading to our Plus Edition and unlock awesome features like:', 'simply-schedule-appointments' ),
    'plusTextBullets' => 
    array (
      'google' => __( 'Google Calendar Sync', 'simply-schedule-appointments' ),
      'customFields' => __( 'Custom Fields', 'simply-schedule-appointments' ),
      ...
      'classes' => __( 'Book Classes and Group Events', 'simply-schedule-appointments' ),
    ),
    'plusTextCta' => 
    array (
    ...
    'proText' => __( 'Woah—looks like you’re really getting the hang of this whole scheduling thing. Just a suggestion, but you might be a great fit for our Pro Edition and its supercharged features:', 'simply-schedule-appointments' ),
    'proTextBullets' => 
    array (
      'payments' => __( 'Accept Payments via PayPal and Stripe', 'simply-schedule-appointments' ),
      'reminders' => __( 'Email and SMS Reminders', 'simply-schedule-appointments' ),
      'tracking' => __( 'Conversion and Goal Tracking', 'simply-schedule-appointments' ),
      'webhooks' => __( 'Unlimited Webhooks', 'simply-schedule-appointments' ),
    ...
    'webMeetingsText' => __( 'Upgrade to set dynamic web meeting URLs when customers book appointments. Also: sync appointments with your Google Calendar, add customers to your MailChimp list, and create booking forms for your customers.', 'simply-schedule-appointments' ),
  ),
  'settings' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'label' => __( 'Get beta (pre-release) versions of SSA', 'simply-schedule-appointments' ),
    ...
    array (
      ...
      array (
        ...
        'staffEnableDesc' => __( 'Shoud each customer booking this appointment type be matched with a team member?', 'simply-schedule-appointments' ),
  ...
  array (
    ...
    'viewRescheduled' => __( 'View rescheduled appointment', 'simply-schedule-appointments' ),
